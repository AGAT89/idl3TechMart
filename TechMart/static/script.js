        ...
        .then(productos => {
            ...
            productos.forEach(producto => {
                ...
                fila.innerHTML = `
                    ...
                    <td>
                        <button class="btn-editar" onclick="mostrarEditarProducto(${producto.id}, '${producto.nombre}', '${producto.descripcion}', ${producto.precio}, ${producto.stock})">Editar</button>
...
function agregarBotonCerrarSesion() {
    ...
    botonCerrarSesion.classList.add("btn-cerrar-sesion");
